...
<div class="card-group">
    <div class="card" style="background-color: #b3f0ff;;">
        <center>
            <img src="IMG/mess1.jpg" class="card-img-top" alt="..."
    ...
    <div class="card" style="background-color: #b3f0ff;">
        <center>
            <img src="IMG/mess2.png" class="card-img-top" alt="..."
                style="height:300px ; width: 300px;border-radius: 30px; margin-top: 20PX;">
            <div class="card-body">
                <p></p>
    ...
    <div class="card" style="background-color: #b3f0ff;">
        <center>
            <img src="IMG/OIP.jpeg.jpg" class="card-img-top" alt="..."
                style="height:300px ; width: 300px;border-radius: 30px; margin-top: 20PX;">
            <div class="card-body">
                <p></p>
...
<center>
<div class="container">
    <div class="title">Mess Attandence</div>
    <div class="content">
      <form method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            <span class="details">Type your Mess 1 And Mess 2</span>
            <input type="text" placeholder="Enter your Mess Name" required name="messtype">
          </div>
          <div class="input-box">
            <span class="details">Type Present and Absent</span>
            <input type="text" placeholder="Enter you are Present or Absent " required name="present">
          </div>
        </div>
...
if(isset($_POST["submit"]))
 {
  ...
  $con=mysqli_connect('localhost','root','','hostel_management_suraj'); 
    $qry="INSERT INTO mess (`full_name`,`roll`,`number`,`email`,`messtype`,`present`)
     VALUES ('$full_name','$roll','$number','$email','$messtype','$present');";
...
<footer class="site-footer">
    <div class="container">
        <div class="row">
            <div class="col-sm-7">
                <h6>About</h6>
                <p> Hostel Management Software offers a comprehensive set of features, ranging from multi-property
