...
<body>
    ...
    <body>
        ...
        <center>
            <div class="container">
                <div class="title">Apply For New Room</div>
                <div class="content">
                    <form method="post">
                        <div class="user-details">
                            ...
                            <div class="input-box">
                                <span class="details">Previous Room No or New For Filled(NA)</span>
                                <input type="text" placeholder="Enter your Room Number" required name="room1">
                            </div>
...
if(isset($_POST["submit"]))
 {
  ...
  $con=mysqli_connect('localhost','root','','hostel_management_suraj'); 
    $qry="INSERT INTO room (`full_name`,`roll`,`number`,`email`,`room1`)
     VALUES ('$full_name','$roll','$number','$email','$room1');";
